                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="review-content-section">
                                        <div id="dropzone1" class="pro-ad addcoursepro">
                                            <form action="{{url('update-quizchildcatagory',$quizChildCatagories->quiz_child_catagory_id)}}" method="GET" class="dropzone dropzone-custom needsclick addcourse" id="demo1-upload">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="form-group">
                                                            <input value="{{$quizChildCatagories->quiz_child_catagory_name}}" name="quiz_child_catagory_name" type="text" class="form-control" placeholder="Course Sub Catagory  Name">
                                                        </div>
