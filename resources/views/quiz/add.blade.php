                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="review-content-section">
                                        <div id="dropzone1" class="pro-ad addcoursepro">
                                            <form action="{{url('addQuizData')}}"
                                                class="dropzone dropzone-custom needsclick addcourse" id="demo1-upload">
                                                @csrf
                                                <input type="hidden" name="edit_quiz_id" id="edit_quiz_id"
                                                    value="{{@$quiz[0]->quiz_id}}">
                                                <input type="hidden" id="_token" value="{{ csrf_token() }}">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <label class="form-label">Title</label>
                                                        <div class="form-group res-mg-t-15">
                                                            <input name="text" value="{{@$quiz[0]->quiz_title}}"
                                                                id="quiz_title" type="text" class="form-control"
                                                                placeholder="Quiz Title">
                                                        </div>

                                                        <div class="form-group">
                                                        <label class="form-label">Quiz Thumbnail</label>
                                                            <input name="thumbnail" id="quiz_thumbnail" type="file"
                                                                class="form-control">
                                                            <input type="hidden" value="{{@$quiz[0]->thumbnail}}"
                                                                name="file_upload_quiz_thumbnail"
                                                                id="file_upload_quiz_thumbnail" />
                                                            @if(@$quiz[0]->thumbnail!="")
                                                            <img src="/uploads/Postimg/{{@$quiz[0]->thumbnail}}"
                                                                style="text-align: center;" id="quiz_thumbnail_img"
                                                                height="100" width="100" />
                                                            @else
                                                            <img src="thumbnail.png" style="text-align: center;"
                                                                id="quiz_thumbnail_img" height="100" width="100" />
                                                            @endif
                                                        </div>
                                                        <div class="form-group">
                                                        <label class="form-label">Quiz Catagory</label>
                                                            <select class="form-control select3 select2-danger"
                                                                ...
                                                                <option <?php if (@$quiz[0]->qid == $item->qid) {
                                                                    ...
                                                                    {{$item->quiz_catagories_name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                        <label class="form-label">Quiz Sub Catagory</label>
                                                            <select class="form-control select3 select2-danger"
                                                                name="q_sid" id="q_sid"
                                                                data-dropdown-css-class="select2-danger"
                                                                style="width: 100%;" required>
                                                                ...
                                                                <option <?php if (@$quiz[0]->q_sid == $item->q_sid) {
                                                                    ...
                                                                    {{$item->quiz_sub_catagory_name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                        <label class="form-label">Quiz Child Catagory</label>
                                                            <select class="form-control select3 select2-danger"
                                                                name="quiz_child_catagory_id" id="quizchild_catagory_id"
                                                                data-dropdown-css-class="select2-danger"
                                                                style="width: 100%;" required>
                                                                ...
                                                                <option <?php if (@$quiz[0]->quiz_child_catagory_id == $item->quiz_child_catagory_id) {
                                                                            echo 'selected';
                                                                        } ?> value="{{$item->quiz_child_catagory_id}}">
                                                                    {{$item->quiz_child_catagory_name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <div style="display: flex;">
                                                                ...
                                                                <div>
                                                                    <input value="Add" onclick=teacherItems();
                                                        ...
                                                        <div class="form-group">
                                                        <label class="form-label">Marks for Correction</label>
                                                            <input type="number"
                                                                value="{{@$quiz[0]->marks_for_correction}}"
                                                                name="marks_for_correction" id="marks_for_correction"
                                                                class="form-control"
                                                                placeholder="Marks for Correct Answer">
                                                        </div>
                                                        <div class="form-group">
                                                        <label class="form-label">Negative Marks</label>
                                                            <input type="number" value="{{@$quiz[0]->negative_marks}}"
                                                                class="form-control" name="negative_marks"
                                                                id="negative_marks" placeholder="Negative Marks%  ">
                                                        </div>
                                                        <div class="form-group">
                                                        <label class="form-label">Pass Marks</label>
                                                            <input type="number" value="{{@$quiz[0]->pass_marks}}"
                                                                class="form-control" id="pass_marks" name="pass_marks"
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="form-group">
                                                        <label class="form-label">No of Option</label>
                                                            <input type="number" class="form-control" id="no_of_option"
                                                                value="{{@$quiz[0]->no_of_option}}"
                                                                placeholder="No of Option per Question ">
                                                        </div>
                                                        <div class="form-group">
                                                        <label class="form-label">Quiz Time</label>
                                                            <input type="number" class="form-control"
                                                                value="{{@$quiz[0]->quiz_time}}" name="quiz_time"
                                                                id="quiz_time" placeholder="Quiz Time ">
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-check">
                                                                ...
                                                                <input <?php if (@$quiz[0]->practise_mode == 1) {
                                                                            echo 'checked';
                                                                        } ?> type="checkbox" id="practise_mode"
                                                                    value="1" class="form-check-input">
                                                                <label class="form-check-label">Practise Mode
                                                                    &nbsp;</label>
                                                                <input <?php if (@$quiz[0]->random_question == 1) {
                                                                            echo 'checked';
                                                                        } ?> type="checkbox" id="random_question"
                                                                    value="1" class="form-check-input">
                                                                <label class="form-check-label">Random Question
                                                                    &nbsp;</label>
                                                                <input <?php if (@$quiz[0]->random_option == 1) {
                                                                            echo 'checked';
                                                                        } ?> type="checkbox" id="random_option"
                                                                    class="form-check-input">
                                                                <label class="form-check-label">Random Option
                                                                    &nbsp;</label>
                                                                <input <?php if (@$quiz[0]->report_question == 1) {
                                                                            echo 'checked';
                                                                        } ?> type="checkbox" id="report_question"
                                                                    class="form-check-input">
                                                                <label class="form-check-label">Report Questions
                                                                    &nbsp;</label>
                                                            </div>
                                                    ...
                                                    <div class="col-lg-1">
                                                        <div class="payment-adress">
                                                            <button id="saveQuizSetting_id" type="button"
                                                                onclick="saveQuizSetting();"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="devit-card-custom">
                                                        ...
                                                        <div class="form-group">
                                                            <input name="Upload Questions" type="file"
                                                                class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input name="" id="importquestionfrombank"
                                                                onkeyup="searcQuestionBank();"
                                                                placeholder="Search question bank"
                                                                onfocus="clearfield('importquestionfrombank');"
                                                                type="text" class="form-control">
                                                            <ul id="myULForBank">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" onkeyup="searchQuizTitle();"
                                                                onfocus="clearfield('searchQuiz');" name="searchQuiz"
                                                                id="searchQuiz" class="form-control"
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="devit-card-custom">
                                                        ...
                                                        <div class="form-group">
                                                            <button type="submit"
                                                                class="btn btn-info waves-effect waves-light">Download
                                                                sample file</button>
                                                        </div>
                                                            ...
                                                            <div style="display: flex;">
                                                                <div style="width: 90%; margin-right:10px;">
                                                                    <select class="form-control select3 select2-danger"
                                                                        ...
                                                                        <option
                                                                            value="{{$item->question_bank_id }}[#]{{$item->question_bank_name}}">
                                                                            {{$item->question_bank_name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div>
                                                                    <input value="Add"
                                                                        onclick=question_bank_nameItems();
                                                                        class="btn btn-success waves-effect waves-light"
                                                                        type="button"></input>
                                                                </div>
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <div class="devit-card-custom">
                                                                                <div style="margin-top: 25px;"
                                                                                    ...
                                                                                    <select
                                                                                        class="form-control select3 select2-danger"
                                                                                        id="correctOptionValue"
                                                                                        data-dropdown-css-class="select2-danger"
                                                                                        style="width: 100%;" required>
                                                                                        <option value="0">Choose Correct
                                                                                            Option </option>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                                        ...
                                        <table class="table table-striped" id="DataTableQuestionFromSearch">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><input type="checkbox" id="unselectall"
                                                            onchange="unselectallitems();" checked></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            </tbody>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" onclick="insertQuestions();" class="btn btn-primary">Save
                                    changes</button>
                            </div>
                        </div>
                    </div>
        ...
        $.ajax({
            ...
            success: function(dataResult) {
                ...
                for (var i = 0; i < response.length; i++) {
                    var str = '<tr><td>' + response[i].questions_id + '</td><td>' + response[i]
                        .question_title +
                        '</td> <td><a style="font-size:20px;" href="javascript:;" onclick="editQuestion(' +
                        response[i].questions_id +
                        ')" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a style="font-size:20px;" href="javascript:;" onclick="deleteQuestion(' +
                        response[i].questions_id + ',' + response[i].quiz_id +
                        ');"  data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td></tr>';
...
function updateQuestionBankAndId(bank_id, bankName) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (var i = 0; i < response.length; i++) {
                var str = '<tr><td>' + response[i].questions_id + '</td><td>' + response[i].question_title +
                    '</td> <td><input onchange="unselectthis(' + response[i].questions_id +
                    ');" type="checkbox" id="qsn' + response[i].questions_id + '" value="' + response[i]
                    .questions_id + '" checked></td></tr>';
...
function searcQuestionBank() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $("#myULForBank").html('');
            for (var i = 0; i < response.length; i++) {
                var str = '<li><a href="javascript:;" onclick="updateQuestionBankAndId(' + response[i]
                    .question_bank_id + ',\'' + response[i].question_bank_name + '\');">' + response[i]
                    .question_bank_name + '</a></li>';
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (var i = 0; i < response.questionBank.length; i++) {
                question_bank = response.questionBank[i].question_bank_id + "[#]" + response.questionBank[i]
                    .question_bank_name;
            ...
            for (let i = 0; i < response.quizAnswerOption.length; i++) {
                ...
                answer.push(response.quizAnswerOption[i].answer_option + '{#}' + response.quizAnswerOption[
                    i].answer + '{#}' + correct);
            }
            $("#datatableTeacher tbody").empty();
            displayBasketItemIntoAnswerTable();
...
function displayBasketItemIntoquestion_bank_nameTable() {
    ...
    for (let i = 0; i < item_questionBank.length; i++) {
        ...
        var str = '<tr><td>' + question_bank + '</td><td onclick="removeQuestionbank(\'' + item_questionBank[i] +
            '\')"> <i class="fa fa-times"></i></tr>';
...
function displayBasketItemIntoAnswerTable() {
    ...
    for (let i = 0; i < answer.length; i++) {
        var str = '<tr><td>' + answer[i].split("{#}")[0] + '</td><td>' + answer[i].split("{#}")[1] +
            '<div style="visibility:hidden;  height: 2px;" id="ans' + i + '">' + answer[i] + '</div></td><td>' + answer[
                i].split("{#}")[2] + '</td><td onclick="removeAnswer(' + i + ')"> <i class="fa fa-times"></i></tr>';
