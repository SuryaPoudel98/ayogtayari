                    ...
                    <div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
                        <ul>
                            ...
                            <li data-index="rs-100" data-transition="parallaxvertical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="error-404.html" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="A STUDY ON HAPPINESS" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="Science says that Women are generally happier">
                                <!-- MAIN IMAGE -->
                                <img src="{{asset('onlinecourse/assets/images/slider/clipart-education.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina />
            ...
            <div class="content-block">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="service-bx">
                                    <div class="action-box">
                                        <img src="{{asset('onlinecourse/assets/images/our-services/pic1.jpg')}}" alt="">
                                    </div>
                                    <div class="info-bx text-center">
                                        <div class="feature-box-sm radius bg-white">
                                            <i class="fa-solid fa-arrow-up" style="color: #3f189a;"></i>
                                        </div>
                                        <h4><a href="#">Top Courses</a></h4>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="service-bx">
                                    <div class="action-box">
                                        <img src="{{asset('onlinecourse/assets/images/our-services/pic2.jpg')}}" alt="">
                                    </div>
                                    <div class="info-bx text-center">
                                        <div class="feature-box-sm radius bg-white">
                                            <i class="fa fa-book text-primary" style="color: #3f189a;"></i>
                                        </div>
                                        <h4><a href="#">Best Selling Courses</a></h4>
                                        <a href="#" class="btn radius-xl">View More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="service-bx m-b0">
                                    <div class="action-box">
                                        <img src="{{asset('onlinecourse/assets/images/our-services/pic3.jpg')}}" alt="">
                                    </div>
                                    <div class="info-bx text-center">
                                        <div class="feature-box-sm radius bg-white">
                                            <i class="fa fa-file-text-o text-primary" style="color: #3f189a;"></i>
                                        </div>
                                        <h4><a href="/all-courses">Recently Added Courses</a></h4>
                                        <a href="/all-courses" class="btn radius-xl">View More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="item">
                                    <div class="cours-bx">
                                        <div class="action-box">
                                            ...
                                            <a href="{{url('coursedetails', $course->course_id)}}" class="btn display-btn">Read More</a>
                                    ...
                                    <div class="advanced-timing">
                                        <div class=" course-level " style="width: 33.33%; ">
                                            <i class="fa-solid fa-signal "></i>
                                            <p>Advanced</p>
                                        </div>
                                        <div class="course-timing " style="width: 33.33%; ">
                                            <i class="fa-regular fa-clock "></i>
                                            <p>1hr 40min</p>
                                        </div>
                                        <div class="total-course " style="width: 33.33%; ">
                ...
                <div class="section-area section-sp2 popular-courses-bx">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 heading-bx left">
                                <h2 class="title-head">Popular <span>Quizes</span></h2>
                                <p>It is a long established fact that a reader will be distracted by the readable content of a page</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                                ...
                                <div class="item">
                                    <div class="cours-bx">
                                        <div class="action-box">
                                            <img src="/uploads/Postimg/{{@$course->thumbnail}}" alt="">
                                            <a href="{{url('quizdetails', $course->quiz_id )}}" class="btn display-btn">Read More</a>


                                        </div>
                                        <div class="info-bx text-center">
                                            <h5><a href="{{url('quizdetails', $course->quiz_id )}}">{{@$course->quiz_title}}</a></h5>
                                            <span>{{@$course->quiz_catagories_name}}</span>
                                        </div>
                                        <div class="cours-more-info">
                                            <div class="review">
                                                <span>3 Review</span>
                ...
                <!-- End Popular quiz -->
                <!-- <div class="section-area section-sp2 " style="margin-top:0px!important; padding-top:0px!important ">
                    <div class="container ">
                        <div class="row ">
                            <div class="col-md-12 heading-bx left ">
                                <h2 class="title-head ">Upcoming<span> Courses</span></h2>
                                <p>It is a long established fact that a reader will be distracted by the readable content of a page</p>
                            </div>
                        </div>
                        <div class="row ">
                            <div class="upcoming-event-carousel owl-carousel owl-btn-center-lr owl-btn-1 col-12 p-lr0 m-b30 ">
                                <div class="item ">
                                    <div class="event-bx ">
                                        <div class="action-box ">
                                            <img src="{{asset('onlinecourse/assets/images/event/pic4.jpg')}} " alt=" ">
                                        </div>
                                ...
                                <div class="item ">
                                    <div class="event-bx ">
                                        <div class="action-box ">
                                            <img src="{{asset('onlinecourse/assets/images/event/pic3.jpg')}} " alt=" ">
                                        </div>
                                        <div class="info-bx d-flex ">
                                ...
                                <div class="item ">
                                    <div class="event-bx ">
                                        <div class="action-box ">
                                            <img src="{{asset('onlinecourse/assets/images/event/pic2.jpg')}} " alt=" ">
                                        </div>
                                        <div class="info-bx d-flex ">
                    ...
                    <div class="container ">
                        ...
                        <div class="testimonial-carousel owl-carousel owl-btn-1 col-12 p-lr0 ">
                            <div class="item ">
                                <div class="testimonial-bx ">
                                    <div class="testimonial-thumb ">
                                        <img src="{{asset('onlinecourse/assets/images/testimonials/pic1.jpg')}} " alt=" ">
                                    </div>
                            ...
                            <div class="item ">
                                <div class="testimonial-bx ">
                                    <div class="testimonial-thumb ">
                                        <img src="{{asset('onlinecourse/assets/images/testimonials/pic2.jpg')}} " alt=" ">
                                    </div>
                                    <div class="testimonial-info ">
                                        <h5 class="name ">Peter Packer</h5>
                                        <p>-Art Director</p>
                ...
                <!-- Recent News -->
                <div class="section-area section-sp2 " style="margin-top: 0px; padding-top: 0px; ">
                    <div class="container ">
                        <div class="row ">
                            <div class="col-md-12 heading-bx left ">
                        ...
                        <div class="recent-news-carousel owl-carousel owl-btn-1 col-12 p-lr0 ">
                            ...
                            <div class="item ">
                                <div class="recent-news ">
                                    <div class="action-box ">
                                        <img src="/uploads/Postimg/{{$blog->thumbnail}}" alt=" ">
                                    </div>
                                    <div class="info-bx ">
                                        <ul class="media-post ">
                                        ...
                                        <h5 class="post-title "><a href="{{url('blogdetails', $blog->id)}}">{{$blog->blog_title}}</a></h5>
                                        <p>{{$blog->fewParagraph}}</p>
                                        <div class="post-extra ">
                                            <a href="{{url('blogdetails', $blog->id)}}" class="btn-link ">READ MORE</a>
