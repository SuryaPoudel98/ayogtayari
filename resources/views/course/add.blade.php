            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="product-payment-inner-st">
                    <ul id="myTabedu1" style="line-height:50px;" class="tab-review-design">
                        <li class="active" id="coursetab"><a onclick="hideCourseTab();" href="#course"> Course Settings</a></li>
                        <li id="curriculumntab"><a onclick="displayCourseTab();" href="#curriculumn"> Course Tabs</a></li>
                                    ...
                                    <div class="review-content-section">
                                        <div id="dropzone1" class="pro-ad addcoursepro">
                                            <form method="POST" class="dropzone dropzone-custom needsclick addcourse" id="demo1-upload">
                                                ...
                                                <input type="hidden" name="edit_course_id" id="edit_course_id" value="{{@$course[0]->course_id}}">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="form-group">
                                                            <input name="course_title" value="{{@$course[0]->course_title}}" id="course_title" type="text" class="form-control" placeholder="Course Title">
                                                        </div>
                                                        <div class="form-group">
                                                            <input name="thumbnail" id="course_thumbnail" type="file" class="form-control">
                                                            <input type="hidden" value="{{@$course[0]->thumbnail}}" name="file_upload_course_thumbnail" id="file_upload_course_thumbnail" />
                                                            @if(@$course[0]->thumbnail!="")
                                                            <img src="/uploads/Postimg/{{@$course[0]->thumbnail}}" style="text-align: center;" id="course_thumbnail_img" height="100" width="100" />
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control select3 select2-danger" id="cid" name="cid" data-dropdown-css-class="select2-danger" style="width: 100%;" required>
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control select3 select2-danger" id="s_cid" name="s_cid" data-dropdown-css-class="select2-danger" style="width: 100%;" required>
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control select3 select2-danger" id="child_catagory_id" name="child_catagory_id" data-dropdown-css-class="select2-danger" style="width: 100%;" required>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select onchange="coursePricingListing();" class="form-control select3 select2-danger" id="coursePrice" name="coursePrice" data-dropdown-css-class="select2-danger" style="width: 100%;" required>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" name="course_video_duration" value="{{@$course[0]->course_video_duration}}" id="course_video_duration" class="form-control" placeholder="Video Duration">
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="form-check">
                                                                <input type="checkbox" <?php if (@$course[0]->discussion_with_teacher == 1) {
                                                                                            echo 'checked';
                                                                                        } ?> id="discussion_with_teacher" value="1" class="form-check-input">
                                                                <label class="form-check-label">Teacher Disscussion</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="checkbox" <?php if (@$course[0]->allow_review == 1) {
                                                                                            echo 'checked';
                                                                                        } ?> id="allow_review" value="1" class="form-check-input">
                                                                <label class="form-check-label">Allow Review</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="checkbox" <?php if (@$course[0]->allow_file_attach_for_discussion == 1) {
                                                                                            echo 'checked';
                                                                                        } ?> id="allow_file_attach_for_discussion" value="1" class="form-check-input">
                                                                <label class="form-check-label">Allow File For Disccussion</label>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-2">
                                                                <div class="payment-adress">
                                                                    ...
                                                                    <input value="Save Course Setting" type="button" onclick="saveCourseSetting();" class="btn btn-primary waves-effect waves-light"></input>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="review-content-section">
                                        ...
                                        <form class="dropzone dropzone-custom needsclick addcourse" id="demo1-upload">
                                            <div class="row">
                                                <input type="hidden" id="course_id" name="course_id" value="{{@$course[0]->course_id}}">
                                                <input type="hidden" id="course_curriculumn_id" name="course_curriculumn_id" value="">
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="devit-card-custom">
                                                        <div class="form-group">
                                                            <input type="text" name="display_name" id="display_name_curriculumn" class="form-control" placeholder=" Display Name">
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" name="lesson" id="lesson_curriculumn" class="form-control" placeholder="Lesson">
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" id="sub_lesson_curriculumn" name="sub_lesson" placeholder="Sub Lesson">
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" id="child_lesson_curriculumn" name="child_lesson" placeholder="Child Lesson">
                                                        </div>
                                                        <div class="form-group">
                                                            <!-- <div class="form-check">
                                                            ...
                                                            <div class="form-check">
                                                                <input type="checkbox" id="enablereview" value="1" class="form-check-input">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-1">
                                                            <div class="payment-adress">
                                                                <button type="button" onclick="saveCurriculumn();" class="btn btn-primary waves-effect waves-light">Save Course Curriculumn</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <table class="table table-striped" id="DataTableCurriculumn">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div id="currricullmn{{$item->id}}" style="display:none;">{!! $item->description !!}</div>
                                                            </td>
                                                            <td><a style="font-size:20px;" href="javascript:;" onclick="editCurriCullmn('{{$item->id}}','{{$item->display_name}}','{{$item->lesson}}','{{$item->sub_lesson}}','{{$item->child_lesson}}', '{{$item->lesson_preview}}')" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a style="font-size:20px;" href="javascript:;" onclick="deleteCurricullmn('{{$item->id }}','{{$item->course_id}}');" id="basicError" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        @endforeach
                                    ...
                                    <div class="review-content-section">
                                        ...
                                        <form class="dropzone dropzone-custom needsclick addcourse" id="demo1-upload">
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="devit-card-custom">
                                                        <input type="hidden" name="course_mcqs_id" id="course_mcqs_id" value="">
                                                        <div class="form-group">
                                                            <input type="text" name="display_name" id="mcqsdisplay_name" class="form-control" placeholder=" Display Name">
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" name="lesson" id="mcqslesson" class="form-control" placeholder="Lesson">
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" id="mcqssub_lesson" name="sub_lesson" placeholder="Sub Lesson">
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" id="mcqschild_lesson" name="child_lesson" placeholder="Child Lesson">
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="hidden" name="quiz_id" id="quiz_id" class="form-control">
                                                            <input type="text" onkeyup="searchQuizTitle();" name="searchQuiz" id="searchQuiz" class="form-control" placeholder="Search quiz">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-check">
                                                                <input type="checkbox" id="mcqs_enable_preview" value="1" class="form-check-input">
                                                                <label class="form-check-label">Enable Preview</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-1">
                                                            <div class="payment-adress">
                                                                <button type="button" onclick="saveMcqs();" class="btn btn-primary waves-effect waves-light">Save MCQS</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <table class="table table-striped" id="DataTableQuiz">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a style="font-size:20px;" href="javascript:;" onclick="editCourseMcqs('{{$item->id}}','{{$item->display_name}}','{{$item->lesson}}','{{$item->sub_lesson}}','{{$item->child_lesson}}', '{{$item->lesson_preview}}','{{$item->quiz_title}}','{{$item->quiz_id}}')" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a style="font-size:20px;" href="javascript:;" onclick="deleteCourseMcqs('{{$item->id }}','{{$item->course_id}}');" id="basicError" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        @endforeach
                                    ...
                                    <div class="review-content-section">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="devit-card-custom">
                                                    <div class="form-group">
                                                        <input type="hidden" name="course_video_id" id="course_video_id" value="">
                                                        <input type="text" name="display_name" id="videodisplay_name" class="form-control" placeholder=" Display Name">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" name="lesson" id="videolesson" class="form-control" placeholder="Lesson">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="videosub_lesson" name="sub_lesson" placeholder="Sub Lesson">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="videochildlesson" name="child_lesson" placeholder="Child Lesson">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="devit-card-custom">
                                                    ...
                                                    <div class="form-group">
                                                        <form action="" method="POST" id="file-upload" enctype="multipart/form-data">
                                                            ...
                                                            <div class="mb-3">
                                                                <label class="form-label" for="inputFile">Select VideoFile:</label>
                                                                <input type="file" name="file" id="inputFile" class="form-control">
                                                                <input type="hidden" id="video_file" name="video_file" class="form-control" placeholder="Video File">

                                                                <span class="text-danger" id="file-input-error"></span>
                                                                <img src="loader.gif" id="video_loader" style="display: none;" height="80" width="80" alt="">
                                                    ...
                                                    <div class="form-check">
                                                        <input type="checkbox" id="video_download_or_not" value="1" class="form-check-input">
                                                        <label class="form-check-label">Allow Download</label>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="video_enable_preview" value="1" class="form-check-input">
                                                            <label class="form-check-label">Enable Preview</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-2">
                                                        <div class="payment-adress">
                                                            <button type="button" onclick="saveVideo();" class="btn btn-primary waves-effect waves-light">Save Video</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <table class="table table-striped" id="DataTableVideo">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a style="font-size:20px;" href="javascript:;" onclick="editCourseVideo('{{$item->id}}','{{$item->display_name}}','{{$item->lesson}}','{{$item->sub_lesson}}','{{$item->child_lesson}}', '{{$item->lesson_preview}}', '{{$item->video_file}}','{{$item->url}}','{{$item->downloadornot}}')" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a style="font-size:20px;" href="javascript:;" onclick="deleteCourseVideo('{{$item->id }}','{{$item->course_id}}');" id="basicError" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        @endforeach
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="devit-card-custom">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="hidden" name="course_note_id" id="course_note_id" value="">
                                                        <input type="text" name="display_name" id="notedisplay_name" class="form-control" placeholder=" Display Name">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" name="lesson" id="notelesson" class="form-control" placeholder="Lesson">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="notesub_lesson" name="sub_lesson" placeholder="Sub Lesson">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="notechildlesson" name="child_lesson" placeholder="Child Lesson">
                                                    </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="devit-card-custom">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="hidden" id="file" class="form-control" placeholder="Upload pdf file">


                                                        <form action="" method="POST" id="notefile-upload" enctype="multipart/form-data">
                                                            @csrf

                                                            <div class="mb-3">
                                                                <label class="form-label" for="inputFile">Select Pdf File</label>
                                                                <input type="file" name="file" id="noteinputFile" class="form-control">

                                                                <span class="text-danger" id="notefile-input-error"></span>
                                                                <img src="loader.gif" id="note_loader" style="display: none;" height="80" width="80" alt="">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="noteurl" name="url" placeholder="URL">
                                                    </div>
                                                    <div class="form-check">
                                                        <input type="checkbox" id="note_download_or_not" value="1" class="form-check-input">
                                                        <label class="form-check-label">Allow Download</label>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="note_enable_preview" value="1" class="form-check-input">
                                                            <label class="form-check-label">Enable Preview</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-1">
                                                        <div class="payment-adress">
                                                            <button type="button" onclick="saveNotes();" class="btn btn-primary waves-effect waves-light">Save Note</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <table class="table table-striped" id="DataTableNote">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a style="font-size:20px;" href="javascript:;" onclick="editCourseNote('{{$item->id}}','{{$item->display_name}}','{{$item->lesson}}','{{$item->sub_lesson}}','{{$item->child_lesson}}', '{{$item->lesson_preview}}', '{{$item->file}}','{{$item->url}}','{{$item->downloadornot}}')" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a style="font-size:20px;" href="javascript:;" onclick="deleteCourseNote('{{$item->id }}','{{$item->course_id}}');" id="basicError" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        @endforeach
                                        ...
                                        <form class="dropzone dropzone-custom needsclick addcourse" id="demo1-upload">
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="devit-card-custom">
                                                        <div class="form-group">
                                                            <input type="hidden" name="course_review_id" id="course_review_id" value="">
                                                            <select class="form-control select3 select2-danger" id="star" name="star" data-dropdown-css-class="select2-danger" style="width: 100%;" required>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-1">
                                                                <div class="payment-adress">
                                                                    <button type="button" onclick="saveReview();" class="btn btn-primary waves-effect waves-light">Add review</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <table class="table table-striped" id="DataTableReview">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div id="review{{$item->id}}"> {!! $item->description !!}</div>

                                                            </td>
                                                            <td><a style="font-size:20px;" href="javascript:;" onclick="editCourseReview('{{$item->id}}','{{$item->star}}')" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a style="font-size:20px;" href="javascript:;" onclick="deleteCourseReview('{{$item->id }}','{{$item->course_id}}');" id="basicError" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        @endforeach
                                    ...
                                    <div class="review-content-section">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="devit-card-custom">
                                                    <div class="form-group">
                                                        <input type="hidden" name="course_blog_id" id="course_blog_id" value="">
                                                        <input type="text" name="display_name" id="newsorarticledisplay_name" class="form-control" placeholder=" Display Name">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" name="blog_title" onkeyup="searchBlogTitle();" id="blog_title" class="form-control" placeholder="Search blog">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-check">
                                                            <input type="checkbox" id="enableornot" value="1" class="form-check-input">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-1">
                                                            <div class="payment-adress">
                                                                <button type="button" onclick="saveNewsorArticle();" class="btn btn-primary waves-effect waves-light">Save news or article</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <table class="table table-striped" id="DataTableBlog">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a style="font-size:20px;" href="javascript:;" onclick="editCourseBlog('{{$item->id}}','{{$item->display_name}}','{{$item->blog_id}}','{{$item->blog_title}}','{{$item->enableornot}}')" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a style="font-size:20px;" href="javascript:;" onclick="deleteCourseBlog('{{$item->id }}','{{$item->course_id}}');" id="basicError" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        @endforeach
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <div class="devit-card-custom">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="hidden" name="course_other_id" id="course_other_id" value="">
                                                        <input type="text" name="display_name" id="othersdisplay_name" class="form-control" placeholder=" Display Name">
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-2 mt-2">
                                                        <div class="payment-adress">
                                                            <button type="button" onclick="saveOthersData()" class="btn btn-primary waves-effect waves-light">Submit</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <table class="table table-striped" id="DataTableOtherData">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div id="others{{$item->id}}"> {!! $item->description !!}</div>

                                                            </td>
                                                            <td><a style="font-size:20px;" href="javascript:;" onclick="editCourseOthersData('{{$item->id}}','{{$item->display_name}}')" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a style="font-size:20px;" href="javascript:;" onclick="deleteCourseOthersData('{{$item->id }}','{{$item->course_id}}');" id="basicError" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                                        </tr>
                                                        @endforeach
...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (var i = 0; i < response.length; i++) {
                    var str = '<li><a href="javascript:;" onclick="updateBlogTitleAndId(' + response[i].id + ',\'' + response[i].blog_title + '\');">' + response[i].blog_title + '</a></li>';
            ...
            if (isblank == false) {
                ...
                $.ajax({
                    ...
                    success: function(dataResult) {
                        ...
                        response = dataResult;
                        for (var i = 0; i < response.length; i++) {
                            var str = '<tr><td>' + response[i].lesson + '</td><td>' + response[i].sub_lesson + '</td><td>' + response[i].child_lesson + '</td><td>' + response[i].quiz_title + '</td> <td><a style="font-size:20px;" href="javascript:;" onclick="editCourseMcqs(' + response[i].id + ',\'' + response[i].display_name + '\',\'' + response[i].lesson + '\',\'' + response[i].sub_lesson + '\',\'' + response[i].child_lesson + '\',\'' + response[i].lesson_preview + '\',\'' + response[i].quiz_title + '\',' + response[i].quiz_id + ')" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a style="font-size:20px;" href="javascript:;" onclick="deleteCourseMcqs(' + response[i].id + ',' + response[i].course_id + ');" id="basicError" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td></tr>';
    ...
    function editCourseMcqs(course_mcqs_id, display_name, lesson, sub_lesson, child_lesson, lesson_preview, quiz_title, quiz_id) {
    ...
    function editCourseVideo(course_video_id, display_name, lesson, sub_lesson, child_lesson, lesson_preview, video_file, url, downloadornot) {
    ...
    function deleteCourseBlog(id, courseId) {
        $.ajax({
            ...
            success: function(data) {
                ...
                for (var i = 0; i < response.length; i++) {
                    var str = '<tr><td>' + response[i].display_name + '</td><td>' + response[i].blog_title + '</td> <td><a style="font-size:20px;" href="javascript:;" onclick="editCourseBlog(' + response[i].id + ',\'' + response[i].display_name + '\',\'' + response[i].blog_id + '\',\'' + response[i].blog_title + '\',' + response[i].enableornot + ')" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a style="font-size:20px;" href="javascript:;" onclick="deleteCourseBlog(' + response[i].id + ',' + response[i].course_id + ');" id="basicError" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td></tr>';
    ...
    function editCourseNote(course_note_id, display_name, lesson, sub_lesson, child_lesson, lesson_preview, file, url, downloadornot) {
    ...
    function deleteCourseNote(id, courseId) {
        $.ajax({
            ...
            success: function(data) {
                ...
                for (var i = 0; i < response.length; i++) {
                    var str = '<tr><td>' + response[i].lesson + '</td><td>' + response[i].sub_lesson + '</td><td>' + response[i].child_lesson + '</td><td>' + response[i].url + '</td> <td>' + response[i].file + '</td> <td><a style="font-size:20px;" href="javascript:;" onclick="editCourseNote(' + response[i].id + ',\'' + response[i].display_name + '\',\'' + response[i].lesson + '\',\'' + response[i].sub_lesson + '\',\'' + response[i].child_lesson + '\',\'' + response[i].lesson_preview + '\',\'' + response[i].file + '\',\'' + response[i].url + '\',\'' + response[i].downloadornot + '\')" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a style="font-size:20px;" href="javascript:;" onclick="deleteCourseNote(' + response[i].id + ',' + response[i].course_id + ');" id="basicError" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td></tr>';
            ...
            if (isblank == false) {
                ...
                $.ajax({
                    ...
                    success: function(dataResult) {
                        ...
                        for (var i = 0; i < response.length; i++) {
                            var str = '<tr><td>' + response[i].display_name + '</td><td><div id="others' + response[i].id + '">' + response[i].description + '</div></td> <td><a style="font-size:20px;" href="javascript:;" onclick="editCourseOthersData(' + response[i].id + ',\'' + response[i].display_name + '\')" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a style="font-size:20px;" href="javascript:;" onclick="deleteCourseOthersData(' + response[i].id + ',' + response[i].course_id + ');" id="basicError" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td></tr>';
    ...
    function deleteCourseReview(id, courseId) {
        $.ajax({
            ...
            success: function(data) {
                ...
                for (var i = 0; i < response.length; i++) {
                    var str = '<tr><td>' + response[i].star + '</td><td><div id="review' + response[i].id + '">' + response[i].description + '</div></td> <td><a style="font-size:20px;" href="javascript:;" onclick="editCourseReview(' + response[i].id + ',\'' + response[i].star + '\')" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a style="font-size:20px;" href="javascript:;" onclick="deleteCourseReview(' + response[i].id + ',' + response[i].course_id + ');" id="basicError" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td></tr>';
            ...
            if (isblank == false) {
                ...
                $.ajax({
                    ...
                    success: function(dataResult) {
                        ...
                        for (var i = 0; i < response.length; i++) {
                            var str = '<tr><td>' + response[i].lesson + '</td><td>' + response[i].sub_lesson + '</td><td>' + response[i].child_lesson + '</td><td><div id="currricullmn' + response[i].id + '" style="display:none;">' + response[i].description + '</div></td> <td><a style="font-size:20px;" href="javascript:;" onclick="editCurriCullmn(' + response[i].id + ',\'' + response[i].display_name + '\',\'' + response[i].lesson + '\',\'' + response[i].sub_lesson + '\',\'' + response[i].child_lesson + '\',\'' + response[i].lesson_preview + '\')" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;&nbsp;<a style="font-size:20px;" href="javascript:;" onclick="deleteCurricullmn(' + response[i].id + ',' + response[i].course_id + ');" id="basicError" data-toggle="tooltip" title="" class="pd-setting-ed" data-original-title="Trash"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td></tr>';
